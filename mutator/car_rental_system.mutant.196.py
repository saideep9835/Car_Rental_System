...
class CarRentalSystem:
    ...
    def add_car_to_inventory(self, car_id, car_name):
    ...
    def transfer_rental(self, car_id, from_user_id, to_user_id):
        if not (car_id in self.rented_cars and car_id in self.inventory and from_user_id in self.users and to_user_id in self.users):
